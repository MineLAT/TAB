package me.neznamy.component.shared.rgb;

import lombok.Getter;
import me.neznamy.component.shared.TextColor;
import me.neznamy.component.shared.rgb.format.BukkitFormat;
import me.neznamy.component.shared.rgb.format.CommonFormatter;
import me.neznamy.component.shared.rgb.format.RGBFormatter;
import me.neznamy.component.shared.rgb.gradient.CMIGradient;
import me.neznamy.component.shared.rgb.gradient.CommonGradient;
import me.neznamy.component.shared.rgb.gradient.GradientPattern;
import me.neznamy.component.shared.rgb.gradient.NexEngineGradient;
...
public class RGBUtils {
    ...
    private final GradientPattern[] gradients = {
            ...
            new CommonGradient(Pattern.compile("<#[0-9a-fA-F]{6}>.*?</#[0-9a-fA-F]{6}>"), "<#", 2, 9, 7), //<#RRGGBB>Text</#RRGGBB> // "HTML"
