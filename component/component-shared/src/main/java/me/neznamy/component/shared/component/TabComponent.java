...
import me.neznamy.component.shared.rgb.RGBUtils;
...
public abstract class TabComponent {
    ...
    /** Adventure component converter instance */
    @Nullable
    private static AdventureComponentConverter adventureConverter;
    ...
    public <T> T convert() {
        if (converted == null) converted = StructuredComponentConverter.getInstance().convert(this);
        return (T) converted;
    }
    ...
    public Component toAdventure() {
        if (adventureConverter == null) adventureConverter = new AdventureComponentConverter();
        if (adventureComponent == null) adventureComponent = adventureConverter.convert(this);
