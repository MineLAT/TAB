 ...
 */
public class ModerateComponentConverter extends StructuredComponentConverter<Object> {
    ...
    private final Field ChatBaseComponent_extra = ReflectionUtils.getOnlyField(ChatBaseComponent, List.class);
    ...
    public Object setExtra(@NotNull Object parent, @NotNull List<Object> children) {
        ChatBaseComponent_extra.set(parent, children);
        return parent;
    }
}
